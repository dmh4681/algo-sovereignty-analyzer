...
GOLD_SEED_DATA = [
    ...
    # 1980 - All-time high (nominal)
    ('1980-01', 675.0), ('1980-03', 550.0), ('1980-06', 650.0), ('1980-09', 674.0), ('1980-12', 590.0),
    # 1981
...
SILVER_SEED_DATA = [
    ...
    # 1980 - Hunt brothers spike
    ('1980-01', 35.0), ('1980-03', 21.0), ('1980-06', 17.0), ('1980-12', 16.0),
    # 1985
...
class InflationDataDB:
    ...
    def get_m2_comparison(self) -> List[M2Comparison]:
        ...
        if not peak_ratio:
            peak_ratio = 400  # Fallback: ~$675 gold / $1.6T M2 ≈ 422
    ...
    def get_summary_stats(self) -> Dict[str, Any]:
        ...
        gold_1980 = 675  # January 1980 peak
