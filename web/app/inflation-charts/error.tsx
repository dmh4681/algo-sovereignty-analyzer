...
export default function InflationChartsError({
  error,
  reset,
}: {
    ...
    <div className="max-w-2xl mx-auto py-16 px-4 text-center">
      <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-8">
        ...
        <h2 className="text-xl font-semibold text-red-300 mb-2">
          Inflation Charts Error
        </h2>
        <p className="text-sm text-slate-400 mb-6">
          {error.message || 'Failed to load inflation data. The data source may be temporarily unavailable.'}
        </p>
